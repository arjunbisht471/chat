const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/VideoChat-D_Dn1ufp.js","assets/VideoChat-jrpnNefM.css"])))=>i.map(i=>d[i]);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(N,F){var L=N.length;N.push(F);e:for(;0<L;){var H=L-1>>>1,U=N[H];if(0<l(U,F))N[H]=F,N[L]=U,L=H;else break e}}function n(N){return N.length===0?null:N[0]}function r(N){if(N.length===0)return null;var F=N[0],L=N.pop();if(L!==F){N[0]=L;e:for(var H=0,U=N.length,Je=U>>>1;H<Je;){var Qe=2*(H+1)-1,ft=N[Qe],Te=Qe+1,Oe=N[Te];if(0>l(ft,L))Te<U&&0>l(Oe,ft)?(N[H]=Oe,N[Te]=L,H=Te):(N[H]=ft,N[Qe]=L,H=Qe);else if(Te<U&&0>l(Oe,L))N[H]=Oe,N[Te]=L,H=Te;else break e}}return F}function l(N,F){var L=N.sortIndex-F.sortIndex;return L!==0?L:N.id-F.id}if(typeof performance=="object"&&typeof performance.now=="function"){var a=performance;e.unstable_now=function(){return a.now()}}else{var o=Date,s=o.now();e.unstable_now=function(){return o.now()-s}}var u=[],d=[],g=1,h=null,m=3,w=!1,k=!1,E=!1,B=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(N){for(var F=n(d);F!==null;){if(F.callback===null)r(d);else if(F.startTime<=N)r(d),F.sortIndex=F.expirationTime,t(u,F);else break;F=n(d)}}function v(N){if(E=!1,p(N),!k)if(n(u)!==null)k=!0,Gt(S);else{var F=n(d);F!==null&&Nn(v,F.startTime-N)}}function S(N,F){k=!1,E&&(E=!1,f(T),T=-1),w=!0;var L=m;try{for(p(F),h=n(u);h!==null&&(!(h.expirationTime>F)||N&&!se());){var H=h.callback;if(typeof H=="function"){h.callback=null,m=h.priorityLevel;var U=H(h.expirationTime<=F);F=e.unstable_now(),typeof U=="function"?h.callback=U:h===n(u)&&r(u),p(F)}else r(u);h=n(u)}if(h!==null)var Je=!0;else{var Qe=n(d);Qe!==null&&Nn(v,Qe.startTime-F),Je=!1}return Je}finally{h=null,m=L,w=!1}}var C=!1,M=null,T=-1,j=5,A=-1;function se(){return!(e.unstable_now()-A<j)}function $(){if(M!==null){var N=e.unstable_now();A=N;var F=!0;try{F=M(!0,N)}finally{F?We():(C=!1,M=null)}}else C=!1}var We;if(typeof c=="function")We=function(){c($)};else if(typeof MessageChannel<"u"){var ct=new MessageChannel,dt=ct.port2;ct.port1.onmessage=$,We=function(){dt.postMessage(null)}}else We=function(){B($,0)};function Gt(N){M=N,C||(C=!0,We())}function Nn(N,F){T=B(function(){N(e.unstable_now())},F)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(N){N.callback=null},e.unstable_continueExecution=function(){k||w||(k=!0,Gt(S))},e.unstable_forceFrameRate=function(N){0>N||125<N?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<N?Math.floor(1e3/N):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(N){switch(m){case 1:case 2:case 3:var F=3;break;default:F=m}var L=m;m=F;try{return N()}finally{m=L}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(N,F){switch(N){case 1:case 2:case 3:case 4:case 5:break;default:N=3}var L=m;m=N;try{return F()}finally{m=L}},e.unstable_scheduleCallback=function(N,F,L){var H=e.unstable_now();switch(typeof L=="object"&&L!==null?(L=L.delay,L=typeof L=="number"&&0<L?H+L:H):L=H,N){case 1:var U=-1;break;case 2:U=250;break;case 5:U=1073741823;break;case 4:U=1e4;break;default:U=5e3}return U=L+U,N={id:g++,callback:F,priorityLevel:N,startTime:L,expirationTime:U,sortIndex:-1},L>H?(N.sortIndex=L,t(d,N),n(u)===null&&N===n(d)&&(E?(f(T),T=-1):E=!0,Nn(v,L-H))):(N.sortIndex=U,t(u,N),k||w||(k=!0,Gt(S))),N},e.unstable_shouldYield=se,e.unstable_wrapCallback=function(N){var F=m;return function(){var L=m;m=F;try{return N.apply(this,arguments)}finally{m=L}}}})(Bs);js.exports=Bs;var fd=js.exports;/**
 * @license React
